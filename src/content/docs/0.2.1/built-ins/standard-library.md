...
description: Complete reference of all global functions, math built-ins, and
  data manipulation utilities available without imports in RayQuiro.
slug: 0.2.1/built-ins/standard-library
---
